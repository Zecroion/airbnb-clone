const PerksOfPlace = ({selected}) => {
    return (
        <div className="mt-6 grid gap-x-4 gap-y-4 grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            {selected.includes('wifi') &&
            <label className="bg-white border border-gray-400 p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
